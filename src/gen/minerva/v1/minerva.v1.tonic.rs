        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/minerva.v1.CommandService/SendCommand",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("minerva.v1.CommandService", "SendCommand"));
...
pub mod command_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/minerva.v1.CommandService/SendCommand" => {
                    ...
                    struct SendCommandSvc<T: CommandService>(pub Arc<T>);
                    impl<
                        T: CommandService,
                    ...
                    for SendCommandSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as CommandService>::send_command(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "minerva.v1.CommandService";
...
pub mod unit_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/minerva.v1.UnitService/GetUnit",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("minerva.v1.UnitService", "GetUnit"));
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/minerva.v1.UnitService/ListUnits",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("minerva.v1.UnitService", "ListUnits"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod unit_service_server {
    ...
    #[async_trait]
    pub trait UnitService: std::marker::Send + std::marker::Sync + 'static {
        ///
        async fn get_unit(
            &self,
            request: tonic::Request<super::GetUnitRequest>,
        ) -> std::result::Result<tonic::Response<super::GetUnitResponse>, tonic::Status>;
        ///
        async fn list_units(
            &self,
    ...
    ///
    #[derive(Debug)]
    pub struct UnitServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/minerva.v1.UnitService/GetUnit" => {
                    #[allow(non_camel_case_types)]
                    struct GetUnitSvc<T: UnitService>(pub Arc<T>);
                    impl<
                        T: UnitService,
                    > tonic::server::UnaryService<super::GetUnitRequest>
                    for GetUnitSvc<T> {
                        type Response = super::GetUnitResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UnitService>::get_unit(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/minerva.v1.UnitService/ListUnits" => {
                    ...
                    impl<
                        T: UnitService,
                    > tonic::server::UnaryService<super::ListUnitsRequest>
                    for ListUnitsSvc<T> {
                        type Response = super::ListUnitsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UnitService>::list_units(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for UnitServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "minerva.v1.UnitService";
    impl<T> tonic::server::NamedService for UnitServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod group_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/minerva.v1.GroupService/ListGroups",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("minerva.v1.GroupService", "ListGroups"));
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/minerva.v1.GroupService/GetGroup",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("minerva.v1.GroupService", "GetGroup"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn subscribe_group_updates(
            &mut self,
            request: impl tonic::IntoRequest<super::SubscribeGroupUpdatesRequest>,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<super::SubscribeGroupUpdatesResponse>,
            >,
            tonic::Status,
        > {
            self.inner
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/minerva.v1.GroupService/SubscribeGroupUpdates",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("minerva.v1.GroupService", "SubscribeGroupUpdates"),
                );
...
pub mod group_service_server {
    ...
    pub trait GroupService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_group(
            ...
            tonic::Status,
        >;
        /// Server streaming response type for the SubscribeGroupUpdates method.
        type SubscribeGroupUpdatesStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::SubscribeGroupUpdatesResponse,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        async fn subscribe_group_updates(
            &self,
            request: tonic::Request<super::SubscribeGroupUpdatesRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::SubscribeGroupUpdatesStream>,
            tonic::Status,
        >;
    }
    ///
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/minerva.v1.GroupService/SubscribeGroupUpdates" => {
                    #[allow(non_camel_case_types)]
                    struct SubscribeGroupUpdatesSvc<T: GroupService>(pub Arc<T>);
                    impl<
                        T: GroupService,
                    > tonic::server::ServerStreamingService<
                        super::SubscribeGroupUpdatesRequest,
                    > for SubscribeGroupUpdatesSvc<T> {
                        type Response = super::SubscribeGroupUpdatesResponse;
                        type ResponseStream = T::SubscribeGroupUpdatesStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as GroupService>::subscribe_group_updates(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SubscribeGroupUpdatesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "minerva.v1.GroupService";
...
pub mod location_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/minerva.v1.LocationService/ListLocations",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("minerva.v1.LocationService", "ListLocations"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod location_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/minerva.v1.LocationService/ListLocations" => {
                    #[allow(non_camel_case_types)]
                    struct ListLocationsSvc<T: LocationService>(pub Arc<T>);
                    impl<
                        T: LocationService,
                    ...
                    for ListLocationsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LocationService>::list_locations(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "minerva.v1.LocationService";
...
pub mod simulation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ///
        pub async fn get_simulation_info(
            &mut self,
            request: impl tonic::IntoRequest<super::GetSimulationInfoRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetSimulationInfoResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/minerva.v1.SimulationService/GetSimulationInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("minerva.v1.SimulationService", "GetSimulationInfo"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn subscribe_simulation_updates(
            &mut self,
            request: impl tonic::IntoRequest<super::SubscribeSimulationUpdatesRequest>,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<super::SubscribeSimulationUpdatesResponse>,
            >,
            tonic::Status,
        > {
            self.inner
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/minerva.v1.SimulationService/SubscribeSimulationUpdates",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "minerva.v1.SimulationService",
                        "SubscribeSimulationUpdates",
                    ),
                );
            self.inner.server_streaming(req, path, codec).await
        }
...
pub mod simulation_service_server {
    ...
    pub trait SimulationService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_simulation_info(
            &self,
            request: tonic::Request<super::GetSimulationInfoRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetSimulationInfoResponse>,
            tonic::Status,
        >;
        /// Server streaming response type for the SubscribeSimulationUpdates method.
        type SubscribeSimulationUpdatesStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::SubscribeSimulationUpdatesResponse,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        async fn subscribe_simulation_updates(
            &self,
            request: tonic::Request<super::SubscribeSimulationUpdatesRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::SubscribeSimulationUpdatesStream>,
            tonic::Status,
        >;
    }
    ///
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/minerva.v1.SimulationService/GetSimulationInfo" => {
                    #[allow(non_camel_case_types)]
                    struct GetSimulationInfoSvc<T: SimulationService>(pub Arc<T>);
                    impl<
                        T: SimulationService,
                    > tonic::server::UnaryService<super::GetSimulationInfoRequest>
                    for GetSimulationInfoSvc<T> {
                        type Response = super::GetSimulationInfoResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SimulationService>::get_simulation_info(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetSimulationInfoSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/minerva.v1.SimulationService/SubscribeSimulationUpdates" => {
                    #[allow(non_camel_case_types)]
                    struct SubscribeSimulationUpdatesSvc<T: SimulationService>(
                        pub Arc<T>,
                    );
                    impl<
                        T: SimulationService,
                    > tonic::server::ServerStreamingService<
                        super::SubscribeSimulationUpdatesRequest,
                    > for SubscribeSimulationUpdatesSvc<T> {
                        type Response = super::SubscribeSimulationUpdatesResponse;
                        type ResponseStream = T::SubscribeSimulationUpdatesStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SimulationService>::subscribe_simulation_updates(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SubscribeSimulationUpdatesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "minerva.v1.SimulationService";
